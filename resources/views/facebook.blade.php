					...
					<div class="column col-sm-10 col-xs-11" id="main">
						...
						<div class="navbar navbar-blue navbar-static-top">
							...
							<ul class="nav navbar-nav navbar-right">
							  <li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">{{ Auth::user()->name }}<i class="glyphicon glyphicon-user"></i></a>
								 ...
								 <div class="col-sm-5">
									  ...
									  <div class="well">
										   <form class="form-horizontal" role="form" action="{{ route('post.store') }}" method="post">
											...
											<div class="form-group" style="padding:14px;">
					                <input type="text" class="form-control" placeholder="Kategori (Integer)" name="category_id" value="">
					            </div>
											 <div class="form-group" style="padding:14px;">
											  <textarea name="description" class="form-control" placeholder="Tulis disini"></textarea>
											</div>
													<input class="btn btn-primary pull-right" type="submit" class="btn-btn primary" name="" value="Save" >
