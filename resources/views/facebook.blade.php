				...
				<div class="row row-offcanvas row-offcanvas-left">
					...
					<div class="column col-sm-2 col-xs-1 sidebar-offcanvas" id="sidebar">
						...
						<ul class="nav hidden-xs" id="lg-menu">
							<li class="active"><a href="#featured"><i class="glyphicon glyphicon-list-alt"></i> Profil</a></li>
							<li><a href="#stories"><i class="glyphicon glyphicon-list"></i> Kabar Berita</a></li>
							<li><a href="#"><i class="glyphicon glyphicon-paperclip"></i> Pesan</a></li>
						</ul>
					...
					<div class="column col-sm-10 col-xs-11" id="main">
						...
						<div class="navbar navbar-blue navbar-static-top">
							...
							<ul class="nav navbar-nav">
							  <li>
								<a href="#"><i class="glyphicon glyphicon-home"></i> Kabar </a>
							  </li>
							  <li>
								<a href="#postModal" role="button" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Buat Kiriman</a>
							  </li>
							  <li>
										   ...
										   <form class="form-horizontal" role="form">
											<h4>Buat Kiriman</h4>
											 <div class="form-group" style="padding:14px;">
											  <textarea class="form-control" placeholder="Tulis disini"></textarea>
											</div>
											<button class="btn btn-primary pull-right" type="button">Kirim</button><ul class="list-inline"><li><a href=""><i class="glyphicon glyphicon-upload"></i></a></li><li><a href=""><i class="glyphicon glyphicon-camera"></i></a></li><li><a href=""><i class="glyphicon glyphicon-map-marker"></i></a></li></ul>
										  </form>
									  </div>
